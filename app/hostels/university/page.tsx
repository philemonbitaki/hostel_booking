...
export default function UniversityHostels() {
  const [hostels, setHostels] = useState([
    { id: 1, name: "Clifford", location: "University Campus", price: 18, rating: 4.9, availableRooms: 12, image: "/hostels/clifford.jpg" },
    { id: 2, name: "Bensdonf", location: "University Campus", price: 20, rating: 4.8, availableRooms: 8, image: "/hostels/bensdonf.jpg" },
    { id: 3, name: "Mukasa", location: "University Campus", price: 22, rating: 4.7, availableRooms: 15, image: "/hostels/mukasa.jpg" },
  ]);
  ...
  return (
    <main className="min-h-screen bg-[#0a1628]">
      ...
      <div className="pt-48 px-6 max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-2">🎓 University Hostels</h1>
        <p className="text-white/60 mb-8">Student residences near top universities</p>
          ...
          {hostels.map((h) => (
            <div key={h.id} className="bg-white rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <span className="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full mb-4 inline-block">University</span>
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex items-center justify-between bg-blue-50 rounded-lg p-3">
                    ...
                    <span className="text-sm font-bold text-blue-700">0766632458</span>
                  </div>
                </div>
        ...
        <div className="mt-12">
          ...
          <FeedbackDisplay roomId="university" showForm={true} />
        </div>
      </div>
    </main>
  );
